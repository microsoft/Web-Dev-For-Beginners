...
# Entorno de Prácticas DevOps: Web Dev Curriculum (Adrian Rosel)
...
---
> **Nota del estudiante:** Modificación realizada por **Adrián Rosel** (@adrianrosel) para la actividad de Fork y Pull Request.