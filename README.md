...
# Modiicación del Readme.md para practicagrupal
...
### Comentario
```
git remote add gorigin https://github.com/xander290290/Web-Dev-For-Beginners.2277.git  //comando utilizado para conectar a mi repositorio
```
