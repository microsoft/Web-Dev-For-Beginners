...
*Програма* може да бъде всичко, което е написано с код: уебсайтове, игри и приложения за телефони са програми. Въпреки че е възможно да се създаде програма без писане на код, основната логика се интерпретира от устройството, а тази логика най-вероятно е написана с код. Програма, която *изпълнява* или *стартира* код, изпълнява инструкции. Устройството, с което четете този урок, изпълнява програма, за да го покаже на екрана ви.
...
*Ниските нива на езиците* обикновено изискват по-малко стъпки за интерпретиране на инструкции от устройството в сравнение с *високите нива на езиците*. Въпреки това, високите нива на езиците са популярни заради тяхната четивност и поддръжка. JavaScript се счита за език от високо ниво.
...
Една инструкция в програмата се нарича *израз* и обикновено има символ или разстояние, което маркира къде инструкцията завършва или *се прекратява*. Начинът, по който програмата се прекратява, варира за всеки език.
...
✅ Направете проучване: Сега, когато знаете основите на средата на уеб разработчика, сравнете и контрастирайте я със средата на уеб дизайнера.
...
## Тест след урока
[Тест след урока](https://ashy-river-0debb7803.1.azurestaticapps.net/quiz/2)
