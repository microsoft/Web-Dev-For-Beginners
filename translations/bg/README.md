...
> **Бележка относно тестовете**: Всички тестове са в папката Quiz-app, общо 48 теста с по три въпроса всеки. Те са достъпни [тук](https://ff-quizzes.netlify.app/web/) и приложението за тестове може да се изпълнява локално или да се разположи в Azure; следвайте инструкциите в папката `quiz-app`.  
