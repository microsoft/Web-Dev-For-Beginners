...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-25T22:02:25+00:00",
...
![Gioco finito](../../../6-space-game/images/pewpew.gif)
...
- Teoria
   - [Introduzione alla creazione di giochi con JavaScript](1-introduction/README.md)
- Pratica
   - [Disegnare su canvas](2-drawing-to-canvas/README.md)
   - [Muovere elementi sullo schermo](3-moving-elements-around/README.md)
   - [Rilevamento delle collisioni](4-collision-detection/README.md)
   - [Tenere il punteggio](5-keeping-score/README.md)
   - [Terminare e riavviare il gioco](6-end-condition/README.md)
