...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T13:16:48+00:00",
...
Такође можемо учинити страницу *Контролна табла* подразумеваном страницом наше апликације, јер сада чувамо податке о налогу. Ако подаци нису пронађени, контролна табла се брине о преусмеравању на страницу *Пријава*. У функцији `updateRoute()`, замените резервну опцију `return navigate('/login');` са `return navigate('/dashboard');`.
...
Креирајте другу функцију под називом `refresh`:
