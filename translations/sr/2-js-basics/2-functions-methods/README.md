...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-27T22:09:53+00:00",
...
Када размишљамо о писању кода, увек желимо да осигурамо да је наш код читљив. Иако ово може звучати контраинтуитивно, код се чита много више пута него што се пише. Један од основних алата у програмерском арсеналу за осигурање одрживог кода је **функција**.
...
До сада, функција коју смо направили увек ће излазити на [конзолу](https://developer.mozilla.org/docs/Web/API/console). Понекад је то управо оно што тражимо, посебно када креирамо функције које ће позивати друге услуге. Али шта ако желим да направим помоћну функцију за израчунавање и да ми врати вредност како бих је могао користити негде другде?

Ово можемо урадити коришћењем **враћене вредности**. Враћена вредност се враћа из функције и може се чувати у променљивој на исти начин као што бисмо могли чувати буквалну вредност као што је стринг или број.
...
Као пример, размислите о [setTimeout](https://developer.mozilla.org/docs/Web/API/WindowOrWorkerGlobalScope/setTimeout), који започиње тајмер и извршава код када се заврши. Треба да му кажемо који код желимо да извршимо. Звучи као савршен посао за функцију!
...
Када прослеђујемо функцију као параметар, можемо заобићи креирање унапред и уместо тога је направити као део параметра. Користимо исту кључну реч `function`, али уместо тога је градимо као параметар.
...
### Фат стрелице функције

Један пречица која је уобичајена у многим програмским језицима (укључујући JavaScript) је могућност коришћења онога што се назива **стрелица** или **фат стрелице** функција. Користи посебан индикатор `=>`, који изгледа као стрелица - отуда име! Коришћењем `=>`, можемо прескочити кључну реч `function`.

Хајде да поново препишемо наш код да користимо функцију фат стрелице:
...
Вреди [прочитати мало више о функцијама стрелице](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Functions/Arrow_functions), јер се све више користе у кодним базама. Вежбајте писање функције, а затим је препишите користећи ову синтаксу.
