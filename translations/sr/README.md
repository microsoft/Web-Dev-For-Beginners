...
- додатно читање  
- задатак  
- [квиз након лекције](https://ff-quizzes.netlify.app/)  

> **Напомена о квизовима**: Сви квизови се налазе у фасцикли Quiz-app, укупно 48 квизова са по три питања. Доступни су [овде](https://ff-quizzes.netlify.app/), а апликација за квизове може се покренути локално или поставити на Azure; пратите упутства у фасцикли `quiz-app`.  
