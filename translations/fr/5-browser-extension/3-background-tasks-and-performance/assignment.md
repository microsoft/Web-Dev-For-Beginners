...
- [Google Lighthouse](https://developers.google.com/web/tools/lighthouse) - Audits complets
- [GTmetrix](https://gtmetrix.com/) - Analyse de performance et optimisation
- [WebPageTest](https://www.webpagetest.org/) - Tests en conditions réelles
- [Pingdom](https://tools.pingdom.com/) - Surveillance globale de la performance

**Outils d’analyse spécialisés :**
- [Bundle Analyzer](https://bundlephobia.com/) - Analyse de la taille des bundles JavaScript
- [Outils d’optimisation d’images](https://squoosh.app/) - Opportunités d’optimisation des ressources
- [Analyse des en-têtes de sécurité](https://securityheaders.com/) - Impact sur la performance de la sécurité

## Format des livrables

Créez un rapport professionnel (2-3 pages) incluant :

1. **Résumé exécutif** - Principaux constats et aperçu des recommandations
2. **Méthodologie** - Outils utilisés et approche des tests
3. **Évaluation de la performance actuelle** - Mesures et métriques de référence
4. **Problèmes identifiés** - Analyse détaillée des problèmes avec données à l’appui
5. **Recommandations** - Stratégies d’amélioration priorisées
6. **Feuille de route de mise en œuvre** - Plan d’optimisation étape par étape
