...
```
![多页面应用的更新流程](../../../../translated_images/zh-CN/mpa.7f7375a1a2d4aa77.webp)
...
```
![单页面应用的更新流程](../../../../translated_images/zh-CN/spa.268ec73b41f992c2.webp)
...
![登录时显示错误消息的截图](../../../../translated_images/zh-CN/login-error.416fe019b36a6327.webp)
...
![Screenshot of an example result of the dashboard after styling](../../../../translated_images/zh-CN/screen2.123c82a831a1d14a.webp)
