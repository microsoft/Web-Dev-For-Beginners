...
journey
    ...
    section 打磨
      ...
      完成生态箱: 5: Student
```
![DOM 和闭包](../../../../translated_images/zh/webdev101-js.10280393044d7eaa.webp)
...
flowchart TD
    ...
    style Q fill:#ffebee
```
![DOM 树结构表示](../../../../translated_images/zh/dom-tree.7daf0e763cbbba92.webp)
...
![完成的花园](../../../../translated_images/zh/terrarium-final.0920f16e87c13a84.webp)
