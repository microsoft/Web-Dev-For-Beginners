...
```
![Fluxo de atualização numa aplicação de múltiplas páginas](../../../../translated_images/pt/mpa.7f7375a1a2d4aa77.png)
...
```
![Fluxo de atualização numa aplicação de página única](../../../../translated_images/pt/spa.268ec73b41f992c2.png)
...
![Screenshot mostrando a mensagem de erro exibida durante o login](../../../../translated_images/pt/login-error.416fe019b36a6327.png)
...
![Screenshot of an example result of the dashboard after styling](../../../../translated_images/pt/screen2.123c82a831a1d14a.png)
