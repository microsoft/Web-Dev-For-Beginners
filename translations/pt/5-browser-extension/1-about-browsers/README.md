...
```
![Browser sketchnote](../../../../translated_images/pt/browser.60317c9be8b7f84a.jpg)
...
![early browsers](../../../../translated_images/pt/earlybrowsers.d984b711cdf3a42d.jpg)
...
![screenshot of the Edge browser showing the open edge://extensions page and open settings menu](../../../../translated_images/pt/install-on-edge.d68781acaf0b3d3d.png)
...
![screenshot of the completed extension open in a browser, displaying a form with inputs for region name and API key.](../../../../translated_images/pt/1.b6da8c1394b07491.png)

**Vista de Resultados** – Exibição dos dados da pegada de carbono:
![screenshot of the completed extension displaying values for carbon usage and fossil fuel percentage for the US-NEISO region.](../../../../translated_images/pt/2.1dae52ff08042246.png)
