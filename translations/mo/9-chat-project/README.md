...
![聊天應用程式介面顯示用戶與 AI 助手之間的對話](../../../translated_images/mo/screenshot.0a1ee0d123df681b.png)
...
![GitHub Models AI Playground介面，顯示模型選擇和測試區域](../../../translated_images/mo/playground.d2b927122224ff8f.png)
...
![Playground選擇顯示不同程式語言的程式碼生成選項](../../../translated_images/mo/playground-choice.1d23ba7d407f4758.png)
...
![顯示綠色 "Use this template" 按鈕的模板創建界面](../../../translated_images/mo/template.67ad477109d29a2b.png)  
...
![顯示啟動雲端開發環境選項的 Codespace 創建界面](../../../translated_images/mo/codespace.bcecbdf5d2747d3d.png)  
