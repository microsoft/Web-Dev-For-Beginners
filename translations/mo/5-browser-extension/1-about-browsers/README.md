...
![瀏覽器手繪筆記](../../../../translated_images/mo/browser.60317c9be8b7f84a.jpg)
...
![早期瀏覽器](../../../../translated_images/mo/earlybrowsers.d984b711cdf3a42d.jpg)
...
![Edge 瀏覽器截圖，顯示打開的 edge://extensions 頁面和打開的設置菜單](../../../../translated_images/mo/install-on-edge.d68781acaf0b3d3d.png)
...
**設置視圖** - 初次使用者配置：
![完成的擴充功能在瀏覽器中打開，顯示一個包含地區名稱和 API 密鑰輸入的表單。](../../../../translated_images/mo/1.b6da8c1394b07491.png)

**結果視圖** - 顯示碳足跡數據：
![完成的擴充功能顯示美國 US-NEISO 地區的碳使用量和化石燃料百分比值。](../../../../translated_images/mo/2.1dae52ff08042246.png)
