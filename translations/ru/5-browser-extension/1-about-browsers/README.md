...
![Скетч браузера](../../../../translated_images/ru/browser.60317c9be8b7f84a.webp)
...
![ранние браузеры](../../../../translated_images/ru/earlybrowsers.d984b711cdf3a42d.webp)
...
![скриншот браузера Edge, показывающий открытую страницу edge://extensions и меню настроек](../../../../translated_images/ru/install-on-edge.d68781acaf0b3d3d.webp)
...
![скриншот завершенного расширения, открытого в браузере, отображающего форму с полями ввода для имени региона и ключа API.](../../../../translated_images/ru/1.b6da8c1394b07491.webp)

**Экран результатов** - Отображение данных углеродного следа:
![скриншот завершенного расширения, отображающего значения углеродного использования и процент ископаемого топлива для региона US-NEISO.](../../../../translated_images/ru/2.1dae52ff08042246.webp)
