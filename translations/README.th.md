...
# หลักสูตรการพัฒนาเว็ปสำหรับมือใหม่

ืทีมงาน Azure Cloud ที่ Microsoft มีความยินดีที่จะนำเสนอ การปูพื้นฐาน JavaScript CSS HTML ในหลักสูตรสิบสองสัปดาห์ยี่สิบสี่บทเรียน ในแต่ละบทเรียนนั้นประกอบไปด้วย แบบทดสอบก่อนและหลังเรียน คำแนะนำในการเรียนในแต่ละบท วิธีการแก้ปัญหา การบ้านและอื่นๆอีกมากมาย วิธีการสอนของเราที่เน้่นโครงการเป็นหลักนั้นจะทำให้ผู้เรียนสามารถเรียนรู้ไปในเวลาเดียวกันกับการสร้างผลงานได้ มันจึงเป็นวิธีที่ได้รับการพิสูจน์แล้วว่าจะทำให้ผู้เรียนจดจำสิ่งใหม่ๆได้ดีขึ้น

Azure Cloud Advocates at Microsoft are pleased to offer a 12-week, 24-lesson curriculum all about JavaScript, CSS, and HTML basics. Each lesson includes pre- and post-lesson quizzes, written instructions to complete the lesson, a solution, an assignment and more. Our project-based pedagogy allows you to learn while building, a proven way for new skills to 'stick'.

**ขอขอบคุณจากใจไปถึงผู้เขียนของเรา Jen Looper, Chris Noring, Christopher Harrison, Jasmine Greenaway, Yohan Lasorsa, Floor Drees, and sketchnote artist Tomomi Imura!**

# ไปเริ่มกันเลย

> **สำหรับผู้สอน**, เราได้รวบรวม [คำแนะนำ](for-teachers.md) ในการใช้งานหลักสูตรไว้ในนี้ พวกเราน้อมรับคำติชมใน [discussion forum](https://github.com/microsoft/Web-Dev-For-Beginners/discussions/categories/teacher-corner) นี้!

> **สำหรับผู้เรียน**, ในการใช้งานหลักสูตรนี้ ท่านจะต้อง fork ทั้ง repo นี้และทำแบบฝึกหัดเองทั้งหมด เริ่มจากแบบทดสอบก่อนการบรรยาย และตามด้วยการอ่านการบรรยายจนกระทั่งทำกิจกรรมที่เหลือให้เสร็จ พยายามทำโครงงานจากการทำความเข้าใจในบทเรียนก่อนที่จะคัดลอกโค้ดคำตอบที่มีอยู่แล้ว อย่างไรก็ตาม โค้ดคำตอบสามารถหาได้จากแฟ้ม /solutions ในแต่ละบทเรียน อีกสิ่งหนึ่งที่ทำได้คือตั้งกลุ่มขึ้นมากับเพื่อนแล้วทำไปพร้อมๆกัน สำหรับใครที่อยากเรียนรู้เพิ่มเติม เราแนะนำ [Microsoft Learn](https://docs.microsoft.com/users/jenlooper-2911/collections/jg2gax8pzd6o81?WT.mc_id=academic-13441-cxa) และดูวิดีโอด้านล่าง

[![Promo video](screenshot.png)](https://youtube.com/watch?v=R1wrdtmBSII "Promo video")

> 🎥 กดที่รูปด้านบนเพื่อเล่น มีเนื้อหาเกี่ยวกับโครงการนี้และเหล่าผู้สร้างมันขึ้นมา!
