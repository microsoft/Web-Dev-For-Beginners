...
![Chat app interface showing conversation between user and AI assistant](../../../translated_images/en/screenshot.0a1ee0d123df681b.webp)
...
![GitHub Models AI Playground interface with model selection and testing area](../../../translated_images/en/playground.d2b927122224ff8f.webp)
...
![Playground choice showing code generation options for different programming languages](../../../translated_images/en/playground-choice.1d23ba7d407f4758.webp)
...
```bash
# Method 1: Direct execution in Python (includes auto-reload)
python api.py
...
![Create from template interface showing the green "Use this template" button](../../../translated_images/en/template.67ad477109d29a2b.webp)
...
![Create codespace interface with options for launching cloud development environment](../../../translated_images/en/codespace.bcecbdf5d2747d3d.webp)
