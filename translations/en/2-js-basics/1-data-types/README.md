...
![JavaScript Basics - Data types](../../../../translated_images/en/webdev101-js-datatypes.4cc470179730702c.webp)
...
Variables can store all types of numbers, including decimals or negative numbers. Numbers also can be used with arithmetic operators, covered in the [next section](../../../../2-js-basics/1-data-types).
...
Booleans can be only two values: `true` or `false`. Booleans can help make decisions on which lines of code should run when certain conditions are met. In many cases, [operators](../../../../2-js-basics/1-data-types) assist with setting the value of a Boolean and you will often notice and write variables being initialized or their values being updated with an operator.
