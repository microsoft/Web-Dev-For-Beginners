...
![All About Accessibility](../../../../translated_images/webdev101-a11y.8ef3025c858d897a.hk.png)  
...
**資訊型圖片** - 傳達重要訊息：
```html
<img src="../../../../translated_images/chart.31c7eb0eb5c4450d.hk.png" alt="Sales increased 25% from Q1 to Q2 2024">
```

**裝飾型圖片** - 純視覺效果，無資訊價值：
```html
<img src="../../../../translated_images/decorative-border.b2f3c4d6634fb79d.hk.png" alt="" role="presentation">
```
...
**複雜圖片** - 圖表、圖解、資訊圖：
```html
<img src="../../../../translated_images/complex-chart.c831f461a363b446.hk.png" alt="Quarterly sales data" aria-describedby="chart-description">
...
<picture>
  ...
  <img src="../../../../translated_images/small-chart.c50c7b1bbcce43d8.hk.png" alt="Website traffic increased 40% after accessibility improvements">
</picture>
```
