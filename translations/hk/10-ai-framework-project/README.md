...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T14:21:27+00:00",
...
為了保持對話的狀態，你可以將聊天的回應添加到對話中，這樣對話就會被記住，以下是操作方式：
...
在這裡，我們使用 `bind_tools` 與 `tools` 陣列，從而 LLM `llm_with_tools` 現在擁有這個工具的知識。
