...
如果你在瀏覽器中嘗試當前的HTML檔案，你會看到它卡在顯示`Loading...`。這是因為我們需要添加一些JavaScript代碼來實例化並顯示HTML模板。
...
這個方法首先根據給定的路徑更新當前URL，然後更新模板。屬性`window.location.origin`返回URL的根目錄，允許我們從給定路徑重建完整URL。
