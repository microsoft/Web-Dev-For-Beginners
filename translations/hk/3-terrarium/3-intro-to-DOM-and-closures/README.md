...
journey
    ...
    section 精進
      ...
      完成生態箱: 5: Student
```
![DOM 與閉包](../../../../translated_images/hk/webdev101-js.10280393044d7eaa.png)
...
flowchart TD
    ...
    style Q fill:#ffebee
```
![DOM 樹狀結構圖](../../../../translated_images/hk/dom-tree.7daf0e763cbbba92.png)
...
![finished terrarium](../../../../translated_images/hk/terrarium-final.0920f16e87c13a84.png)
