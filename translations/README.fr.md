...
# Pour commencerhttps://calm-wave-0d1a32b03.1.azurestaticapps.net/
...
> **Une note sur les quiz**: Tous les quiz sont contenus [dans cette application](https://calm-wave-0d1a32b03.1.azurestaticapps.net/), pour un total de 48 quiz de trois questions chacun. Ils sont liés à partir des leçons, mais l’application de quiz peut être exécutée localement; suivez les instructions dans le dossier `quiz-app`. Ils sont progressivement localisés.
