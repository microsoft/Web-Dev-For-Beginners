...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-20T20:58:19+00:00",
...
✅ ایج میں پرفارمنس پینل پر [Microsoft Documentation](https://docs.microsoft.com/microsoft-edge/devtools-guide/performance/?WT.mc_id=academic-77807-sagibbon) دیکھیں۔
...
✅ صفحہ کے وزن اور مزید کے تاریخی جائزے کے لیے [Internet Archive](https://httparchive.org/reports/page-weight) دیکھیں۔
...
✅ سائٹ کی کارکردگی کا تعین کرنے کے لیے کیے جانے والے عام چیکس کے بارے میں مزید جاننے کے لیے [Site Speed Test website](https://www.webpagetest.org/) پر کچھ سائٹس آزمائیں۔
...
کروم.runtime میں [ایک API](https://developer.chrome.com/extensions/runtime) ہے جو ہر قسم کے بیک گراؤنڈ ٹاسکس کو ہینڈل کرتا ہے، اور آپ کا ایکسٹینشن اس کا فائدہ اٹھا رہا ہے:
...
✅ آپ کینوس API کے بارے میں مزید [Space Game lessons](../../6-space-game/2-drawing-to-canvas/README.md) میں سیکھیں گے۔
