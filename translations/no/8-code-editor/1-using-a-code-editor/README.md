...
```mermaid
flowchart LR
    A[⚡ 5 minutter] --> B[Besøk vscode.dev]
    B --> C[Koble til GitHub-konto]
    C --> D[Åpne et hvilket som helst repository]
    D --> E[Start redigering umiddelbart]
```
...
```mermaid
journey
    title Fra lokal oppsett til skyutviklingsmester
    section Forstå plattformen
      Oppdag nettbasert redigering: 4: You
      Koble til GitHub-økosystemet: 6: You
      Mestre grensesnittnavigasjon: 7: You
    section Ferdigheter i filhåndtering
      Opprett og organiser filer: 5: You
      Rediger med syntaksutheving: 7: You
      Naviger prosjektstrukturer: 8: You
    section Mestring av versjonskontroll
      Forstå Git-integrasjon: 6: You
      Øv på commit-arbeidsflyter: 8: You
      Mestre samarbeidsmønstre: 9: You
    section Profesjonell tilpasning
      Installer kraftige utvidelser: 7: You
      Konfigurer utviklingsmiljøet: 8: You
      Bygg personlige arbeidsflyter: 9: You
```  
...
```mermaid
mindmap
  root((VSCode.dev Mesterskap))
    Platform Benefits
      Accessibility
        Enhetsuavhengighet
        Ingen installasjon nødvendig
        Øyeblikkelige oppdateringer
        Universell tilgang
      Integration
        GitHub-tilkobling
        Repository-synkronisering
        Innstillinger vedvarende
        Klar for samarbeid
    Development Workflow
      File Management
        ...
        Autosparingsfunksjoner
      Version Control
        Git-integrasjon
        Commit-arbeidsflyter
        Grenhåndtering
        Endringssporing
    Customization Power
...
![Default VSCode.dev interface](../../../../translated_images/no/default-vscode-dev.5d06881d65c1b323.webp)
...
```mermaid
flowchart TB
    subgraph "VSCode.dev Grensesnitt Arkitektur"
        A[Aktivitetslinje] --> B[Utforsker 📁]
        A --> C[Søk 🔍]
        A --> D[Kildekontroll 🌿]
        A --> E[Utvidelser 🧩]
        A --> F[Innstillinger ⚙️]
        ...
        C --> H[Finn & Erstatt]
        D --> I[Git Status]
        E --> J[Utvidelsesmarked]
        F --> K[Konfigurasjon]
        
        L[Sidelinje] --> M[Kontekstpanel]
        N[Redigeringsområde] --> O[Kodefiler]
        P[Terminal/Utgang] --> Q[Kommandolinje]
    end
```  
...
2. Se etter knappen "Open Remote Repository" på velkomstskjermen og klikk den
   ...
   ![Open remote repository](../../../../translated_images/no/open-remote-repository.bd9c2598b8949e7f.webp)
...
![Command Palette](../../../../translated_images/no/palette-menu.4946174e07f42622.webp)
...
![Creating a new file](../../../../translated_images/no/create-new-file.2814e609c2af9aeb.webp)
...
![Editing files in VSCode.dev](../../../../translated_images/no/edit-a-file.52c0ee665ef19f08.webp)
...
![Viewing changes in Source Control](../../../../translated_images/no/working-tree.c58eec08e6335c79.webp)

**Lagre arbeidet ditt (commit-arbeidsflyten):**

```mermaid
flowchart TD
    A[Gjør endringer i filer] --> B[Vis endringer i Kildekontroll]
    B --> C[Forbered endringer ved å klikke +]
    C --> D[Skriv beskrivende commit-melding]
    D --> E[Klikk på hake for å committe]
    E --> F[Endringer dyttes til GitHub]
```  
```mermaid
stateDiagram-v2
    [*] --> Modified: Rediger filer
    Modified --> Staged: Klikk + for å legge til
    Staged --> Modified: Klikk - for å fjerne
    Staged --> Committed: Legg til melding og bekreft
    Committed --> [*]: Synkroniser til GitHub
    
    state Committed {
        [*] --> LocalCommit
        LocalCommit --> RemotePush: Automatisk synkronisering
    }
```  
...
![Extension marketplace interface](../../../../translated_images/no/extensions.eca0e0c7f59a10b5.webp)  
...
![Customizing extension settings](../../../../translated_images/no/extension-settings.21c752ae4f4cdb78.webp)  
...
```mermaid
timeline
    title Profesjonell skyutviklingsreise
    
    section Plattformgrunnlag
        Cloud Development Understanding
            : Mestre nettbaserte redigeringskonsepter
            : Koble GitHub-integrasjonsmønstre
            : Navigere profesjonelle brukergrensesnitt
    
    section Arbeidsflytbeherskelse
        File & Project Management
            : Opprette organiserte prosjektstrukturer
            : Mestre syntaksuthevingens fordeler
            : Håndtere arbeidsflyter med flere filer
        
        Version Control Integration
            : Forstå Git-visualisering
            : Praktisere retningslinjer for commit-meldinger
            : Mestre arbeidsflyter for endringssporing
    
    section Miljøtilpasning
        Extension Ecosystem
            : Oppdage produktivitetsutvidelser
            : Konfigurere utviklingspreferanser
            : Optimalisere ytelse mot funksjonalitet
        
        Professional Setup
            : Bygge konsistente arbeidsflyter
            : Lage gjenbrukbare konfigurasjoner
            : Etablere teamstandarder
    
    section Bransjeklarhet
        Cloud-First Development
            : Mestre praksis for fjernutvikling
            : Forstå samarbeidende arbeidsflyter
            : Bygge plattformuavhengige ferdigheter
        
        Professional Practices
            : Følge bransjestandarder
            : Lage vedlikeholdbare arbeidsflyter
            : Forberede seg på teammiljøer
```  
