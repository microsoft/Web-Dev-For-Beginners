...
![Edgeプロファイラー](../../../../translated_images/ja/profiler.5a4a62479c5df01c.webp)
...
![Edgeプロファイラースナップショット](../../../../translated_images/ja/snapshot.97750180ebcad737.webp)

イベントログペインを確認して、15ms以上かかったイベントがあるかどうかを確認します:

![Edgeイベントログ](../../../../translated_images/ja/log.804026979f3707e0.webp)
